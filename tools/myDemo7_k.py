...
def demo(net, image_name, dest_path):
    ...
    timer.toc()
    detect_core_time = timer.total_time
    
    print ('Detection core took {:.3f}s for '
           '{:d} object proposals').format(detect_core_time, boxes.shape[0])
    ...
    timer.toc()
    detect_tot_time = timer.total_time
    ...
    #restore boxes to original scale 
    #inverse_scale = 1.0 / scale
    #all_dets[:, :4] = all_dets[:, :4] * inverse_scale
    #all_dets[:, [0,2]] = all_dets[:, [0,2]].clip(0, im_wid - 1)
    #all_dets[:, [1,3]] = all_dets[:, [1,3]].clip(0, im_hei - 1)
...
def parse_args():
    ...
    parser.add_argument('--scl', dest='scale_num', help='How many scales to use in detection [1]',
                        default=1, type=int)
...
if __name__ == '__main__':
    ...
    #python tools/myDemo7_k.py --gpu 1  --conf 0.2 --scl 1
    ...
    #dest_path = "./work_data/faster-rcnn/VGG16/dets_end2end_n0016_train_nosquare_i90200_houzzdata1_val_nosquare/t{:0.1f}/".format(GM.conf_thresh)
    ...
    #dest_path = "./work_data/faster-rcnn/VGG16/dets_end2end_n0016_train_nosquare_i90200_houzzdata1_val_nosquare_mulscl{}/t{:0.1f}/".format(len(GM.test_scale_list), GM.conf_thresh)
    #dest_path = "./work_data/faster-rcnn/RESNET/dets_end2end_n0029_train_nosquare_i150000_houzzdata1_val_nosquare_mulscl{}/t{:0.1f}/".format(len(GM.test_scale_list), GM.conf_thresh)
    dest_path = "./work_data/faster-rcnn/VGG16/dets_end2end_n0016_train_nosquare_i90200_houzzdata1_val_nosquare/mulscl{}/t{:0.1f}/".format(GM.test_scale_list, GM.conf_thresh)
    ...
    #model_basename = "vgg16_faster_rcnn_n0016_iter_80000.caffemodel"
    model_basename = "vgg16_faster_rcnn_n0016_iter_90200.caffemodel"
    #model_basename = "vgg16_faster_rcnn_n0016_iter_90200_svd_fc6_1024_fc7_256.caffemodel"
    #model_basename = "vgg16_faster_rcnn_n0016_iter_90200_svd4_fc6_64_fc7_16.caffemodel"
