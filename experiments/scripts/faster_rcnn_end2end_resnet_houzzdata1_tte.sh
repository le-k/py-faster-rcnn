...
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_tte.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0047
...
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_tte.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0062 TRAIN.SCALES "[600,800,1000]" TRAIN.MAX_SIZE 1200
...
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_tte.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0080 
...
DEST_PATH_ROOT=work_data/faster-rcnn/RESNET/dets_end2end_n0080_train_nosquare_i${ITERS}_houzzdata1_val_nosquare
SCALE_NUM=1
CONF_THRESH=0.2
