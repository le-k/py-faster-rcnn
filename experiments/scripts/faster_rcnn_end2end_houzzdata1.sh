...
# ./experiments/scripts/faster_rcnn_end2end_houzzdata1.sh 0 VGG16  --set TRAIN.SNAPSHOT_INFIX n0001
# ./experiments/scripts/faster_rcnn_end2end_houzzdata1.sh 0 VGG16  --set TRAIN.SNAPSHOT_INFIX n0017 TRAIN.SCALES "[600,800]"
# ./experiments/scripts/faster_rcnn_end2end_houzzdata1.sh 0 VGG16  --set TRAIN.SNAPSHOT_INFIX n0012 TRAIN.FG_THRESH 0.8
