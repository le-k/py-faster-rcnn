...
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0047
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0047 TRAIN.SCALES "[400,500,600]"
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0047 TRAIN.FG_THRESH 0.8
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0062 TRAIN.SCALES "[600,800,1000]" TRAIN.MAX_SIZE 1200
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0064 TRAIN.SCALES "[400,600,800,1000]" TRAIN.MAX_SIZE 1200
# ./experiments/scripts/faster_rcnn_end2end_resnet_houzzdata1_test.sh 1 RESNET --set TRAIN.SNAPSHOT_INFIX n0063 
...
#time ./tools/train_net.py --gpu ${GPU_ID} \
  #--solver models/houzzdata/${NET}/faster_rcnn_end2end_houzzdata1/solver50_v8.prototxt \
  #--weights ${NET_INIT} \
  #--imdb ${DATASET_TRAIN} \
  #--iters ${ITERS} \
...
#CAFFEMODEL=output/faster_rcnn_end2end/houzzdata1_train/resnet50_faster_rcnn_v8_n0080_iter_150000.caffemodel
CAFFEMODEL=output/faster_rcnn_end2end/houzzdata1_train/resnet50_faster_rcnn_n0063_iter_120000.caffemodel
set -x
...
DEST_PATH_ROOT=work_data/faster-rcnn/RESNET/dets_end2end_v8_n0063_train_nosquare_i${ITERS}_houzzdata1_val_nosquare
SCALE_NUM=1

CONF_THRESH=0.01


PROTOTXT=models/houzzdata/RESNET/faster_rcnn_end2end_houzzdata1/test50_v8.prototxt
