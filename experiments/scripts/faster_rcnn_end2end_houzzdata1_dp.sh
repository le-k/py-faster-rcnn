...
# ./experiments/scripts/faster_rcnn_end2end_houzzdata1_dp.sh 0 VGG16  --set TRAIN.SNAPSHOT_INFIX n0001
...
time ./tools/train_net.py --gpu ${GPU_ID} \
  --solver models/${NET}/faster_rcnn_end2end_houzzdata1_dp/solver.prototxt \
  --weights ${NET_INIT} \
  --imdb ${DATASET_TRAIN} \
  --iters ${ITERS} \
